<template>
<f7-popup class="coin-popup"   color-theme="orange" :opened="popupOpened" @popup:closed="popupOpened = false">
    <f7-navbar id="flex-space" >
        <div id="go-back">
    ...
    <f7-block>
      ...
      <f7-block>
          <virtual-list :size="45" :remain="9">
              <f7-button popup-close class="select-btn" outline round v-for="(coin,i) in paginatedData" :value="coin.id" :key="i" @click="selectedCoin(coin)" selected>
